...
?>
	<link href="<?php echo elgg_get_site_url()?>mod/campus-theme/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo elgg_get_site_url()?>mod/campus-theme/font-awesome/css/font-awesome.css" rel="stylesheet">
    <link href="<?php echo elgg_get_site_url()?>mod/campus-theme/css/plugins/toastr/toastr.min.css" rel="stylesheet">
    <link href="<?php echo elgg_get_site_url()?>mod/campus-theme/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
    <link href="<?php echo elgg_get_site_url()?>mod/campus-theme/css/animate.css" rel="stylesheet">
    <link href="<?php echo elgg_get_site_url()?>mod/campus-theme/css/style.css" rel="stylesheet">
	<!--[if gt IE 8]>
